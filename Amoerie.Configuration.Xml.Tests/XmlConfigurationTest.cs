...
<settings>
    ...
    public void ThrowExceptionWhenFindDTD()
    {
      ...
      new Action(() => xmlConfigSrc.Load(TestStreamHelpers.StringToStream(xml))).ShouldThrow<XmlException>()
    ...
    public void ThrowExceptionWhenFindNamespace()
    {
      ...
      new Action(() => xmlConfigSrc.Load(TestStreamHelpers.StringToStream(xml))).ShouldThrow<FormatException>()
        .WithMessage(expectedMsg);
    }
    ...
    public void ThrowExceptionWhenPassingNullAsFilePath()
    {
      ...
      new Action(() => new ConfigurationBuilder().AddXmlFile(path: null)).ShouldThrow<ArgumentException>()
        .WithMessage(expectedMsg);
    }
    ...
    public void ThrowExceptionWhenPassingEmptyStringAsFilePath()
    {
      ...
      new Action(() => new ConfigurationBuilder().AddXmlFile(string.Empty))
        .ShouldThrow<ArgumentException>().WithMessage(expectedMsg);
    }
    ...
    {
      new Action(() => new ConfigurationBuilder().AddXmlFile("NotExistingConfig.xml", optional: false).Build())
